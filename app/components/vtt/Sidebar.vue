  ...
  <div class="bg-black/70 backdrop-blur-sm border border-green-700/50 rounded-lg p-3 text-white h-full flex flex-col">
    ...
    <div class="flex flex-col gap-1.5 flex-1">
      <button
        ...
        :key="oracle.id"
        class="w-full px-3 py-2 text-sm font-heading text-left border rounded transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-green-400/60 active:scale-[0.98]"
        :class="
